		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Oroville",
									"targetURL": "#orovillenmsporovilleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"orovillenmsporovilleapp-display": {
								"semanticObject": "orovillenmsporovilleapp",
								"action": "display",
								"description": "Oroville App",
								"title": "Oroville",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=orovillenmsp.orovilleapp",
									"url": sap.ui.require.toUrl("orovillenmsp/orovilleapp")
								}
							}
						}
					}
